...
API_INVITER_INFO = os.environ["API_INVITER_INFO"] if "API_INVITER_INFO" in os.environ \
    else "https://taxi.sparcs.org/api/events/2026spring/invites/search/{}" # TODO: UPDATE HERE
...
# event type setting
event_type = "event2026spring" # TODO: UPDATE HERE
...
images = {
    ...
    "background.event2026spring": cv2.imread("images/og.background.event2026spring.png"),
    "background.event2026spring.eventInvite": cv2.imread("images/og.background.event2026spring.eventInvite.png"),
...
async def eventInviteHandler(inviterId: str):
    try:
        if not event_type in ["event2024fall", "event2025spring", "event2025fall", "event2026spring"]: # TODO: UPDATE HERE
